...
public class ZhiShiListViewAdapter extends BaseAdapter {
	...
	public ZhiShiListViewAdapter(Context context,
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			arg1 = LayoutInflater.from(context).inflate(
					R.layout.zhishi_listview_item, null);
			hastext.zhishilist_tv = (TextView) arg1
					.findViewById(R.id.zhishilist_tv);
