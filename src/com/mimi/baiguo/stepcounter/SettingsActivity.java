...
public class SettingsActivity extends Activity {
	...
	public static final int Default_Step_Value = 40;// 默认步长

	public static final int Default_Weight_Value = 65;// 默认体重

	public static final int Default_Sersitivity_Value = 3;// 默认灵敏值
	...
	private void init() {
		...
		sensitivity = 10 - sharedPreferences.getInt(SENSITIVITY_VALUE,
				Default_Sersitivity_Value);
		step_length = sharedPreferences.getInt(STEP_LENGTH_VALUE,
				Default_Step_Value);
		weight = sharedPreferences.getInt(WEIGHT_VALUE, Default_Weight_Value);
